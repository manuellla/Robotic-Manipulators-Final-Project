...
% =========================================================================
% ETAPA 1: MOVIMENTO PARA O RETÂNGULO
% =========================================================================
...
title('Trajetória completa: Retângulo - Losango - Círculo');
...
% Pontos Losango
plot3(P5(1), P5(2), P5(3), 'ko', 'MarkerSize', 10, 'MarkerFaceColor','k');
plot3(PL1(1), PL1(2), PL1(3), 'k+');
plot3(P6_losango(1), P6_losango(2), P6_losango(3), 'k+');
plot3(PL2(1), PL2(2), PL2(3), 'k+');
% Ponto Círculo
plot3(P_C_Start(1), P_C_Start(2), P_C_Start(3), 'ro', 'MarkerSize', 8, 'MarkerFaceColor','r');

xlabel('X (m)'); ylabel('Y (m)'); zlabel('Z (m)');
title('Caminho 3D percorrido pelo efetuador');
grid on; axis equal;
legend('Trajetória', 'P0', 'P1(Ret)', 'P2(Ret)', 'P3(Ret)', 'P4(Ret)', 'P5(Los)', 'Ponto Inicial(Circ)');
view(3);
...
for i = 1:length(t)
    ...
    rpy_err = rotm2rpy(R_err); % [roll; pitch; yaw]
